...
function CScustomer_css_alter(&$css) {
 ...
 */
function CScustomer_menu_local_tasks(&$variables) {
    $output = '';
...
*/
function _is_panel_page_customer() {
 ...
 */
function CScustomer_preprocess_page(&$vars, $hook) {
    if (isset($vars['node'])) {
	...
	if($panel_page = _is_panel_page_customer()) {
 ...
 */
function CScustomer_process_page(&$variables) {
 ...
 */
//function CScustomer_breadcrumb($variables) {
 ...
 */
function CScustomer_preprocess_username(&$vars) {
    global $theme_key;
...
function CScustomer_format_comma_field($field_category, $node, $limit = NULL) {
...
function CScustomer_form_contact_site_form_alter(&$form, $form_state) {
 ...
 */
function CScustomer_item_list($vars) {
 ...
 */
function CScustomer_pager_link($variables) {
    $text = $variables['text'];
...
function CScustomer_form_alter(&$form, &$form_state, $form_id) {
 ...
 */
function CScustomer_field($variables) {
...
/**
 * User CSS function. Separate from CScustomer_preprocess_html so function can be called directly before </head> tag.
 */
function CScustomer_user_css() {
 ...
 */
function CScustomer_preprocess_html(&$vars) {
    global $parent_root;
