...
(function(jQuery,undefined){
        ...
        revolution: function(options) {
            ...
            return this.each(function() {
                ...
                if (!container.hasClass("revslider-initialised")) {
                    ...
                    jQuery('.Disable-true').remove();

                    // AMOUNT OF THE SLIDES
                    opt.slideamount = container.find('>ul:first >li').length;
                    //console.error(opt.slideamount);
    ...
    function prepareSlides(container,opt) {
        ...
        container.find('>ul:first >li >img').each(function(j) {
            ...
            img.wrap('<div class="slotholder" style="width:100%;height:100%; position: absolute;"'+
            ...
            if (img.data('lazyload')!=img.attr('src') && alreadyinload<3 && img.data('lazyload')!=undefined && img.data('lazyload')!='undefined') {
                ...
                if ((img.data('lazyload') === undefined || img.data('lazyload') === 'undefined') && img.data('lazydone')!=1) {
                    ...
                    if (img.attr('src')!=undefined && img.attr('src')!='undefined') 	{
                        $('.eapps-facebook-feed-posts-item-content-picture img').each(function() {
                            if ( !this.complete
                                ||   typeof this.naturalWidth == "undefined"
                                ||   this.naturalWidth == 0                  ) {
                                // image was broken, replace with your new image
                                this.src = '/sites/all/modules/art_revolution/rs-plugin/images/error-image-generic.png';
                            }
                        });

                        $('.eapps-instagram-feed-posts-item-image-wrapper img').each(function() {
                            if ( !this.complete
                                ||   typeof this.naturalWidth == "undefined"
                                ||   this.naturalWidth == 0                  ) {
                                // image was broken, replace with your new image
    ...
    function swapSlideProgress(container,opt) {
        ...
        var transitionsArray = [
            ...
            ['noanimation',26,0,1,0,'horizontal',true,null,46]
        ];
        ...
        actli.css({'z-index':90});
        nextli.css({'z-index':92});
...
//
        ...
        allcaptions.each(function(i) {
            ...
            if (handlecaption==0) {
                    ...
                    if (nextcaption.find('video').length>0) {
                        ...
                        nextcaption.find('video').each(function(i) {
                            ...
                            if (!jvideo.parent().hasClass("html5vid")) {
                                jvideo.wrap('<div class="html5vid OpacHidden" style="position:relative;top:0px;left:0px;width:auto;height:auto"></div>');
                ...
                if (!recalled) {
                    ...
                    var delayanimation = nextcaption.data('elementdelay')
                    ...
                    else if (nextcaption.hasClass('roll-in-left') || nextcaption.hasClass('skewfromright')) frm.x = 15+opt.width;
    ...
    function endMoveCaption(nextcaption,opt,mdelay,backwards,frame,downscale) {
        ...
        if (nextcaption.hasClass('ltr') ||
            ...
            nextcaption.hasClass('roll-out-left') ||
            nextcaption.hasClass("randomrotateout"))
        {
            ...
            }else if (nextcaption.hasClass('roll-out-left') || nextcaption.hasClass('skewtorightshort')) {
                frm.x=50;frm.opacity=0;
        ...
        if (nextcaption.data('rotate')) {
            var animobject = $(nextcaption);
            var degree = nextcaption.data('rotate');

            if (animobject.find('#imgclass').length > 0) {
                jQuery(nextcaption).html(animobject.find('#imgclass').css({transform: 'rotate(' + degree + 'deg)'}));
            }
            if (animobject.find('#textclass').length > 0) {
                jQuery(nextcaption).html(animobject.find('#textclass').css({transform: 'rotate(' + degree + 'deg)'}));
            }
            // else {
            //     jQuery(nextcaption).html('<div style="transform: rotate(' + degree + 'deg)">' + $(animobject).text() + '</div>');
            // }
            // var elemdelay = 0;
            //
            // frm.rotation = nextcaption.data('rotate');
            //
            // tl.add(newtl.staggerTo(animobject,mspeed,frm,elemdelay),mdelay);
        }
